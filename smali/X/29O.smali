...
# virtual methods
.method public final A6F(Landroid/content/Context;Ljava/lang/String;)I
    .locals 5
...
.method public final AOQ(Landroid/content/Context;Ljava/lang/String;Z)I
    .locals 8

    .line 270561
    :try_start_0
    const-class v7, LX/1CE;
    ...
    :cond_0
    :try_start_4
    invoke-static {v1}, LX/1CE;->A03(Ljava/lang/ClassLoader;)V
    :try_end_4
    .catch LX/1C9; {:try_start_4 .. :try_end_4} :catch_0
    ...
    :cond_2
    :try_start_6
    invoke-static {p1, p2, p3}, LX/1CE;->A00(Landroid/content/Context;Ljava/lang/String;Z)I

    move-result v0

    .line 270579
    sget-object v3, LX/1CE;->A05:Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v1}, LX/1CF;-><init>(Ljava/lang/String;Ljava/lang/ClassLoader;)V

    .line 270581
    invoke-static {v2}, LX/1CE;->A03(Ljava/lang/ClassLoader;)V
    ...
    sput-object v1, LX/1CE;->A04:Ljava/lang/Boolean;

    goto :goto_1
    :try_end_6
    .catch LX/1C9; {:try_start_6 .. :try_end_6} :catch_1
    ...
    .line 270591
    :goto_3
    sput-object v0, LX/1CE;->A04:Ljava/lang/Boolean;
    ...
    return v0
    :try_end_f
    .catch LX/1C9; {:try_start_f .. :try_end_f} :catch_5
    ...
    .line 270597
    invoke-static {p1}, LX/1CE;->A02(Landroid/content/Context;)LX/1CG;
    ...
    .line 270601
    iget-object v0, v4, LX/1Ch;->A01:Ljava/lang/String;
    ...
    .line 270603
    invoke-virtual {v4, v0, v1}, LX/1Ch;->A00(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v2, p1}, LX/0Qh;-><init>(Ljava/lang/Object;)V
