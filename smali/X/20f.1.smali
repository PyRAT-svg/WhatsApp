...
.method public synthetic constructor <init>(Lcom/whatsapp/util/crash/SigquitBasedANRDetector;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, LX/20f;->A00:Lcom/whatsapp/util/crash/SigquitBasedANRDetector;

    iput-object p2, p0, LX/20f;->A01:Ljava/lang/String;

    iput-object p3, p0, LX/20f;->A02:Ljava/lang/String;
...
.method public final run()V
    ...
    iget-object v3, p0, LX/20f;->A00:Lcom/whatsapp/util/crash/SigquitBasedANRDetector;

    iget-object v2, p0, LX/20f;->A01:Ljava/lang/String;

    iget-object v4, p0, LX/20f;->A02:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A05:LX/03Z;

    new-instance v5, Ljava/io/File;

    iget-object v0, v0, LX/03Z;->A03:LX/00K;
    ...
    :try_start_7
    iget-object v1, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A06:LX/03f;
    ...
    iget-object v0, v1, LX/03f;->A02:LX/20i;

    invoke-static {v0}, LX/20i;->A00(LX/20i;)V
    ...
    iget-object v5, v3, Lcom/whatsapp/util/crash/SigquitBasedANRDetector;->A06:LX/03f;

    new-instance v7, LX/2Wl;

    invoke-direct {v7, v3, v4}, LX/2Wl;-><init>(Lcom/whatsapp/util/crash/SigquitBasedANRDetector;Ljava/io/File;)V

    iget-object v1, v5, LX/03f;->A05:Landroid/content/Context;
    ...
    :try_start_c
    iget-object v1, v5, LX/03f;->A02:LX/20i;

    if-eqz v1, :cond_4

    iget v0, v5, LX/03f;->A00:I

    if-eqz v0, :cond_4

    invoke-static {v1}, LX/20i;->A00(LX/20i;)V

    :cond_4
    iget-wide v8, v5, LX/03f;->A01:J

    const-wide/16 v0, 0x1

    add-long/2addr v8, v0

    iput-wide v8, v5, LX/03f;->A01:J

    new-instance v4, LX/20i;

    invoke-direct/range {v4 .. v9}, LX/20i;-><init>(LX/03f;Landroid/app/ActivityManager;LX/20j;J)V

    iput-object v4, v5, LX/03f;->A02:LX/20i;

    const/4 v0, 0x1

    iput v0, v5, LX/03f;->A00:I
    ...
    invoke-virtual {v0, v4}, LX/03Z;->A02(Ljava/io/File;)V
