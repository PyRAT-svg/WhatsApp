...
.method public synthetic constructor <init>(Lcom/whatsapp/gdrive/GoogleDriveService;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/String;Ljava/io/File;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    iput-object p1, p0, LX/1uR;->A00:Lcom/whatsapp/gdrive/GoogleDriveService;

    iput-object p2, p0, LX/1uR;->A05:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p3, p0, LX/1uR;->A02:Ljava/lang/String;

    iput-object p4, p0, LX/1uR;->A01:Ljava/io/File;

    iput-object p5, p0, LX/1uR;->A03:Ljava/lang/String;

    iput-object p6, p0, LX/1uR;->A04:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final run()V
    ...
    iget-object v8, v1, LX/1uR;->A00:Lcom/whatsapp/gdrive/GoogleDriveService;

    iget-object v0, v1, LX/1uR;->A05:Ljava/util/concurrent/atomic/AtomicReference;

    move-object/from16 v29, v0

    iget-object v12, v1, LX/1uR;->A02:Ljava/lang/String;

    iget-object v15, v1, LX/1uR;->A01:Ljava/io/File;

    iget-object v9, v1, LX/1uR;->A03:Ljava/lang/String;

    iget-object v0, v1, LX/1uR;->A04:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    if-eqz v0, :cond_0
    :try_end_0
    .catch LX/2UE; {:try_start_0 .. :try_end_0} :catch_7
    .catch LX/2UD; {:try_start_0 .. :try_end_0} :catch_6
    .catch LX/2UH; {:try_start_0 .. :try_end_0} :catch_5
    .catch LX/2UF; {:try_start_0 .. :try_end_0} :catch_4
    ...
    iget-object v0, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0f:LX/07t;
    ...
    invoke-static/range {v21 .. v21}, LX/007;->A0K(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_1
    iget-object v0, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0k:LX/0Kp;
    ...
    iget-object v1, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A06:LX/2R5;
    ...
    :try_end_1
    .catch LX/2UE; {:try_start_1 .. :try_end_1} :catch_7
    .catch LX/2UD; {:try_start_1 .. :try_end_1} :catch_6
    .catch LX/2UH; {:try_start_1 .. :try_end_1} :catch_5
    .catch LX/2UF; {:try_start_1 .. :try_end_1} :catch_4
    ...
    :cond_3
    :try_start_2
    iget-object v2, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0k:LX/0Kp;
    ...
    invoke-direct/range {v22 .. v27}, LX/2Tx;-><init>(Lcom/whatsapp/gdrive/GoogleDriveService;ZLjava/lang/String;Ljava/lang/String;Ljava/io/File;)V
    ...
    iget-object v0, v9, LX/0Pq;->A06:Ljava/lang/String;
    ...
    iget-object v0, v9, LX/0Pq;->A05:Ljava/lang/String;
    ...
    iget-wide v0, v9, LX/0Pq;->A01:J

    invoke-static {v2, v0, v1}, LX/007;->A10(Ljava/lang/StringBuilder;J)V

    iget-object v0, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0B:LX/1wf;

    if-eqz v0, :cond_6

    invoke-virtual {v0, v9}, LX/1wf;->A05(LX/0Pq;)V
    ...
    iget-object v3, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0Z:LX/00E;
    ...
    iget-object v4, v8, Lcom/whatsapp/gdrive/GoogleDriveService;->A0h:LX/2U3;
    ...
    throw v12
    :try_end_3
    .catch LX/2UE; {:try_start_3 .. :try_end_3} :catch_7
    .catch LX/2UD; {:try_start_3 .. :try_end_3} :catch_6
    .catch LX/2UH; {:try_start_3 .. :try_end_3} :catch_5
    .catch LX/2UF; {:try_start_3 .. :try_end_3} :catch_4
    .catch LX/2UJ; {:try_start_3 .. :try_end_3} :catch_3
    .catch LX/2UA; {:try_start_3 .. :try_end_3} :catch_2
    .catch LX/2UG; {:try_start_3 .. :try_end_3} :catch_1
