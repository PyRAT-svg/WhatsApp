...
.method public synthetic constructor <init>(Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;Landroid/app/Activity;)V
    ...
    iput-object p1, p0, LX/1LF;->A01:Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;

    iput-object p2, p0, LX/1LF;->A00:Landroid/app/Activity;
...
.method public final run()V
    ...
    iget-object v1, v0, LX/1LF;->A01:Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;

    iget-object v0, v0, LX/1LF;->A00:Landroid/app/Activity;
    ...
    iget-object v7, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0D:LX/04h;
    ...
    iget-object v2, v7, LX/04h;->A0A:LX/01A;

    iget-object v14, v2, LX/01A;->A03:Lcom/whatsapp/jid/UserJid;

    iget-object v2, v7, LX/04h;->A0I:LX/0BJ;
    ...
    iget-object v8, v7, LX/04h;->A0u:LX/0BG;
    ...
    invoke-virtual {v8, v7}, LX/0BG;->A08(Landroid/os/Message;)V
    ...
    iget-object v5, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0A:LX/07g;
    ...
    invoke-virtual/range {v5 .. v10}, LX/07g;->A0A(Landroid/app/Activity;ZLcom/whatsapp/jid/UserJid;Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    iget-object v3, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0B:LX/0MQ;

    iget-object v2, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A04:Lcom/whatsapp/jid/UserJid;

    invoke-virtual {v3, v0, v2, v4, v4}, LX/0MQ;->A02(Landroid/content/Context;LX/01W;ZZ)V

    iget-object v2, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0K:LX/090;

    invoke-virtual {v2}, LX/090;->A03()V

    iget-object v2, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0I:LX/0B2;
    ...
    invoke-virtual/range {v2 .. v7}, LX/0B2;->A0F(LX/01W;ILjava/lang/String;ZZ)V

    iget-object v2, v1, Lcom/whatsapp/CallSpamActivity$ReportSpamOrBlockDialogFragment;->A0J:LX/07b;
    ...
    invoke-virtual/range {v2 .. v7}, LX/07b;->A03(ILX/01W;JI)V
