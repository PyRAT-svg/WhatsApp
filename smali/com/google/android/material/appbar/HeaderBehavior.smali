...
.method public A0G(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 304619
    iget-object v6, v2, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A02:LX/1G6;

    if-eqz v6, :cond_c

    .line 304620
    iget v13, v6, LX/1G6;->A03:I
    ...
    invoke-direct {v3, v2, v9, v10}, LX/1G5;-><init>(Lcom/google/android/material/appbar/HeaderBehavior;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V

    .line 304626
    iput-object v3, v2, Lcom/google/android/material/appbar/HeaderBehavior;->A05:Ljava/lang/Runnable;

    invoke-static {v10, v3}, LX/0SQ;->A0f(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public A0J()I
    ...
    iget-object v0, v2, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A02:LX/1G6;

    if-eqz v0, :cond_0

    iget v1, v0, LX/1G6;->A03:I
...
.method public A0M(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    iget-object v3, v8, LX/1G0;->A01:Landroid/view/animation/Interpolator;
    ...
    :cond_1
    invoke-static {v9}, LX/0SQ;->A0k(Landroid/view/View;)Z
    ...
    :goto_1
    iget-object v2, v5, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A02:LX/1G6;

    if-eqz v2, :cond_8

    iget v0, v2, LX/1G6;->A03:I

    if-eq v0, v3, :cond_7

    iput v3, v2, LX/1G6;->A03:I

    invoke-virtual {v2}, LX/1G6;->A00()V
    ...
    :cond_3
    iget-object v0, v5, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A02:LX/1G6;
